...
FROM (
         VALUES
             ...
             ('testimonial-get-id','GET','/all/*',false,'testimonial'),
...
FROM (
         VALUES
             ...
             ('CMS_ADMIN', ARRAY[
                 ...
                 'testimonial-create','testimonial-list','testimonial-get', 'testimonial-get-id','testimonial-update','testimonial-delete',
             ...
             ('STAFF', ARRAY[
                 ...
                 'testimonial-get-id', 'review-create','review-list','review-get',
                 'media-list','media-get',
